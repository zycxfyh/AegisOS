...
pr-fast: 12/12 PASS | full: 37/37 ALL PASS (26 hard + 11 escalation) | 3 open debt | Phase 8: DEFERRED
...
204 backend tests. 57 frontend tests. 37/37 baseline (26 hard + 11 escalation).

Checker ecosystem: 37 checkers (26 hard, 11 escalation) across L3-L10.
...
**pr-fast**: 12/12 hard gates. **full**: 37/37 ALL PASS (26 hard + 11 escalation). 3 open debt.
