...
FORBID = [
    ...
    ("stop_loss", "stop_loss in Core"),
    ("max_loss_usdt", "max_loss_usdt in Core"),
    ("is_chasing", "is_chasing in Core"),
    ("is_revenge_trade", "is_revenge_trade in Core"),
    ("place_order", "place_order in Core"),
    ("execute_trade", "execute_trade in Core"),
]
