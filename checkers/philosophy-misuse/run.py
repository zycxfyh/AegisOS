...
RULES = [
    (
        ...
        "Run Anti-Overforce review.",
    ),
    (
        "PGI-MISUSE-002",
        re.compile(r"\bfreedom\b.{0,120}\b(?:all[- ]in|high leverage|gamble|double down)\b", re.I),
        "Freedom language used to rationalize gambling.",
        "Run Finance Pack risk gate.",
    ),
    (
        "PGI-MISUSE-003",
        re.compile(
        ...
        "Discipline used to suppress body/emotion signals.",
        "Classify signal before increasing effort.",
    ),
    (
        "PGI-MISUSE-004",
        re.compile(
        ...
        "Restore EvidenceRecord requirement.",
    ),
    (
        "PGI-MISUSE-005",
        re.compile(
        ...
        "Non-attachment used to avoid responsibility.",
        "Separate non-force from avoidance.",
    ),
    (
        "PGI-MISUSE-006",
